...
proc scope::plotScopeData {} {
	...
	if {$firstSample < 0} {set firstSample 0}
	if {$lastSample > 1022} {set lastSample 1022}
...
proc scope::manualTrigger {} {
	...
	if {$scope::intExt} {
		...
		set autoTriggerHandle [after 500 {scope::manualTrigger;set scope::triggered 0}]
	}
